...
% function warnmsg(varargin)
%
% Return a better warning message,
% with stack traces messages similar to errormsg.
%
...
%
% Example:
% % print current scope with the warning msg
% % 
% warnmsg('Testing warnmsg-> 1+1=%d',2)
%
...
%
if nargin == 0
    warnmsg('Not enough input arguments');
end
