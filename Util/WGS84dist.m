function varargout = WGS84dist(lat1,lon1,lat2,lon2)
% WGS84DIST - Using the WGS-84 Earth ellipsoid, compute the distance between
...
%
% s = WGS84dist(lat1,lon1,lat2,lon2)
% [s,a12] = WGS84dist(lat1,lon1,lat2,lon2)
% [s,a12,a21] = WGS84dist(lat1,lon1,lat2,lon2)
%
...
%            apart. This function (WGS84dist) is more accurate in such cases.
%            For example, note this difference (as of this writing):
%            >>WGS84dist(0.2,305,15,125)
%            18322827.0131551
