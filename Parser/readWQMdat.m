function sample_data = readWQMdat(filename, mode)
    ...
    params{end + 1} = {'CHL(ug/l)', {'CPHL', getCPHLcomment('unknown')}}; %older files
    params{end + 1} = {'CHLa(ug/l)', {'CPHL', getCPHLcomment('unknown')}}; %older files
    params{end + 1} = {'F-Cal-CHL(ug/l)', {'CPHL', getCPHLcomment('factory')}};
    params{end + 1} = {'Fact-CHL(ug/l)', {'CPHL', getCPHLcomment('factory')}};
    params{end + 1} = {'U-Cal-CHL(ug/l)', {'CPHL', getCPHLcomment('user')}};
